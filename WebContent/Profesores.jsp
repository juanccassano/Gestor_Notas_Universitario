...
<input type="hidden" id= "ProfesorSeleccionado" name="ProfesorSeleccionado" onChange="pruebaFc()">
...
<table id="TablaProf" class="table table-hover table-dark">
  <thead>
    <tr>
...
listP = persD.obtenerTodos("'Profesor'");
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalLabelNuevo">Alta profesor</h5>
...
<div class="modal fade" id="modalModif" tabindex="-1" role="dialog" aria-labelledby="modalLabelModif" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalLabelModif">Modificar profesor</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<div class="modal fade" id="modalBorrar" tabindex="-1" role="dialog" aria-labelledby="modalLabelBorrar" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalLabelBorrar">Borrar profesor</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
{	
    ...
    $('#TablaProf tbody').on( 'click', 'tr', function () {
        ...
        //$(this).toggleClass('selected');
              ...
              $("#ProfesorSeleccionado").val(table.rows(['.selected']).data().pluck(0).toArray());
                     var value = $("#ProfesorSeleccionado").val();
                     if(value > 0){
    ...
    function jsFunction(){
    	  ...
    	  $.post("ServletProfesor" ,{"provSelecN": provSelecN}, function(responseJson) {
    ...
    $( "#modalBorrar" ).on('shown.bs.modal', function(){
        var legajo = $("#ProfesorSeleccionado").val();

            $("#txtLegB").val(legajo);
            $("#ProfesorSeleccionado").val(null);
